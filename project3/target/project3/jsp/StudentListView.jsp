...
<%@page import="in.co.rays.project3.ctl.StudentListCtl"%>
			...
			<div class="container-fluid text-center">
				<div class="form-inline mr-5">
					...
					<div class="form-group  text-center mr-5">
						&emsp;&emsp; <label class="control-label"
				...
				<div class="form-group text-center">
						<label class="control-label" for="login">Email Id
							:&emsp;</label>
