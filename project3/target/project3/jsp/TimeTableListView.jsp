<%@page import="in.co.rays.project3.ctl.TimeTableListCtl"%>
			...
			<div class="container-fluid text-center">
				...
				<div class="form-group text-center">
						<label class="control-label" for="courseName">Course Name
							:&emsp;</label> 
							<%=HTMLUtility.getList("courseName", String.valueOf(dto.getCourseId()), list1)%>
							</div>

                   &emsp;&emsp;&emsp;
				<div class="form-group text-center">
						<label class="control-label" for="Exdate">Exam Date
							:&emsp;</label> 
					<input placeholder="Enter Exam Date" type="date" id="datepicker"
						name="Exdate" class="form-control" onkeydown="return false"
                 ...
                 &emsp;&emsp;&emsp;&emsp;&emsp;
					...
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=TimeTableListCtl.OP_SEARCH%>">&emsp;&emsp; <input
