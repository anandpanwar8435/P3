...
public class MarksheetListCtl extends BaseCtl{
	...
	protected void preload(HttpServletRequest request) {
		...
		/*
		 * StudentModelInt model = ModelFactory.getInstance().getStudentModel(); try {
		 * List list = model.list(0,0); request.setAttribute("slist", list);
		 * 
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		dto.setId(DataUtility.getLong(request.getParameter("rollId")));
		 ...
		 //dto.setStudentId(DataUtility.getLong(request.getParameter("name")));
