...
<%@page import="in.co.rays.project3.ctl.RoleListCtl"%>
...
<body class="hm-gradient">
	...
	<div>
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="in.co.rays.project3.dto.RoleDTO" scope="request"></jsp:useBean>
			<%
			...
			<br>
			<!-- <div class="row">
				<div class="col-sm-5" style="margin-left: -60px; margin-right: 60px;"></div> -->
				...
				<div class="form-inline mr-5">
					...
					<div class="form-group  text-center mr-5">
						...
						&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
						 <label class="control-label" for="Role">Name : &emsp;</label>
			...
			<div class="col-sm-2" style="margin-left: 170px;"> -->
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=RoleListCtl.OP_SEARCH%>">&emsp;&emsp; <input
